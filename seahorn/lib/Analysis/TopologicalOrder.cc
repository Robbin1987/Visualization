...
namespace seahorn
{
  ...
  bool TopologicalOrder::isBackEdge (const BasicBlock &src, const BasicBlock &dst) const
  {
...
static llvm::RegisterPass<seahorn::TopologicalOrder> X ("topo", "Topological order of CFG", 
                                                        true, true);
