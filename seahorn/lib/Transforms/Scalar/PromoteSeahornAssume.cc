...
namespace 
{
  ...
  public:
    ...
    bool runOnFunction (Function &F)
    {
      ...
      for (auto &I : boost::make_iterator_range(inst_begin (F),
                                                inst_end (F)))
      {
                   ...
                   fn->getName ().equals ("verifier.assume.not")))
        {
          ...
          if (hasAssumeUsers (*arg)) continue;
...
X ("promote-seahorn-assume", "Promote seahorn assume to llvm assume intrinsic");
