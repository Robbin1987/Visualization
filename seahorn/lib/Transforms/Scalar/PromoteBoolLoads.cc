        ...
        while (I != E)
        {
          if (TruncInst *trunc = dyn_cast<TruncInst> (&*I))
          {
            ...
            if (! (trunc->getType ()->isIntegerTy (1) &&
                   ...
                   isa<LoadInst> (trunc->getOperand (0)))) { ++I;  continue;}
...
namespace seahorn
{
  Pass* createPromoteBoolLoadsPass ()
  {return new PromoteBoolLoads ();}
}

static llvm::RegisterPass<PromoteBoolLoads> 
X ("promote-bools", "Promote _Bool loads");
