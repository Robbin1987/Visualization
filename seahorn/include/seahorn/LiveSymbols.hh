...
namespace seahorn
{
  ...
  public:
    ...
    LiveInfo (const LiveInfo &o) :
      m_live (o.m_live), m_defs (o.m_defs), 
      m_edgeDefs (o.m_edgeDefs) {}
    ...
    const ExprVector& edge_defs (unsigned i) const 
    {
      return m_edgeDefs[i];
    }
  ...
  class LiveSymbols
  {
    ...
    void symExecPhi (SymStore &s, const BasicBlock &bb, const BasicBlock &from);
